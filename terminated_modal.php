        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="staff_dashboard.php?terminated"><button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <form action="update_staff_terminated.php" method="POST">
                    ...
                    <div class="modal-footer">
                      <a href="staff_dashboard.php?terminated"><button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button></a>
